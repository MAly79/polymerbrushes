...
2- MDPBB.in: This is a LAMMPS input script that creates the Polymer Brush Bilayer.
            ...
            - The molecules are grafted randomly to the surface atoms of two opposing FCC Walls
...
3- ecs.in: This is a LAMMPS script that performs the simulation (Equilibration, Compression and Shearing).
           - It reads the MDPBB.rst file generated by MDPBB.in.
           - Define the bond_style and bond_coeff for the FENE and harmonic potentials(walls)
           ...
           - Output:
                    ...
                    - *beads_*dz : Bead density profiles in the z direction (*=(a)ll,(b)ottom,(t)op ,*=e,c,s)
